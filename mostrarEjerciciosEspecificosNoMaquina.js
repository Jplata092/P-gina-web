...
function mostrarEjerciciosEspecificos(ejercicios, grupoMuscular) {
    ...
    const ejerciciosFiltrados = ejercicios.filter(ej => ej.musculo === grupoMuscular && ej.tipo === "nomaquina");
    console.log("Ejercicios filtrados para mostrar (tipo nomaquina):", ejerciciosFiltrados);  // Depuración
    ...
    if (ejerciciosFiltrados.length === 0) {
        console.warn("No se encontraron ejercicios de tipo 'nomaquina' para este grupo muscular.");
        return;
    }
